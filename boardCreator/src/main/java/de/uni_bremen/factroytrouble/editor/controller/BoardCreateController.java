...
/**
 * Controller zum erstellen eines Boards.
 *
 * @Author Andre
 */
@Controller
public class BoardCreateController extends AbstractEditorController {

    private static final String BOARD_TYPE_STRING = "Board";
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        markerGrid.getChildren().remove(0);
    }
    ...
    private void saveBoard(ActionEvent actionEvent) {
        String filename = fileNameAlertService.showFilenameAlert(BOARD_TYPE_STRING);
        if(filename != null) {
            saveBoardService.saveBoard(tileGridPane, filename);
        }
    }
