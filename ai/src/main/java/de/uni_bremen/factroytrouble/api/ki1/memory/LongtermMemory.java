...
public interface LongtermMemory {
    void storeChunk(Chunk chunk) throws LongTermStoreChunkException;
    void memoryDecay(int passedTime) throws KeyNotFoundException;
    Chunk retrieveChunk(Key key) throws KeyNotFoundException;
