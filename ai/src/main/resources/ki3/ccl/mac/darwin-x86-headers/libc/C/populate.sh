...
CFLAGS="-m32 -msse2 -isysroot ${SDK} -D_DARWIN_NO_64_BIT_INODE -mmacosx-version-min=10.8"; export CFLAGS
...
h-to-ffi.sh -include ${SDK}/usr/include/sys/types.h ${SDK}/usr/include/mach/shared_region.h
